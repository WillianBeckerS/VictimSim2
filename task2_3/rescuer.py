...
from utilities import Stack, Node, Centroid, Cluster
import itertools
import heapq
import numpy as np
...
class Rescuer(AbstAgent):
    ...
    ''' genetic algorithm to determine the rescue sequence '''
    ...
    ''' Builds clusters and assigns each rescuer '''
    ...
    ''' A* used to calculate path between victims '''
